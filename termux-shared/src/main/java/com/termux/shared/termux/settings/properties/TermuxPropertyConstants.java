...
public final class TermuxPropertyConstants {
    ...
    public static final String DEFAULT_IVALUE_EXTRA_KEYS = "[['ESC',{key: '/', popup: 'FILE'},{key: '-', popup: '|'},'HOME','UP','END','PGUP','BKSP'], ['TAB','CTRL','ALT','LEFT','DOWN','RIGHT','PGDN','ENTER']]"; // Double row
